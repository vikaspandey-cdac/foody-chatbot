...
def results(loc,cuisine,budgetmin, budgetmax):
	...
	df = pd.DataFrame()
	for i in list1:
		print(" parameters to request restaurant search :: ", lat, lon, "cuisine :: "+cuisine ,str(cuisines_dict.get(cuisine)), i)
